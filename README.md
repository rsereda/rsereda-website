# hugo Resume for Roman Sereda cloud expert based on [Start Bootstrap - Resume](https://github.com/eddiewebb/hugo-resume)

site can be found [romansereda.com](https://romansereda.com)
